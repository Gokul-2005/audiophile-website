  ...
  return (
    <div id="About" className={style.About}>
      ...
      <div className={style.bottom}>
        ...
        <lottie-player src="https://assets4.lottiefiles.com/private_files/lf30_igfaivqx.json"  background="transparent"  speed="1"  style={{width: "70vh", height: "70vh",}}  loop  autoplay></lottie-player>
        </div>
        ...
        <h3 className={style.classForAboutH3}>• I will develop UI as per user requirements.</h3>
