  ...
  return (
    <div id='Intro' className={style.Intro}>
      ...
      <div className={style.Right}>
        ...
        <lottie-player src="https://assets10.lottiefiles.com/packages/lf20_pa2kzq5x.json"  background="transparent"  speed="1"  style={{width: "18vh", height: "18vh",marginLeft:"5vh"}}  loop  autoplay></lottie-player>
